  ...
  return (
    <>
      <div className="flex items-center justify-between mb-4">
        ...
        <button className="flex items-center gap-2 " onClick={fetchProfileById}>
      ...
      <div className=" mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg  border border-gray-300 dark:border-gray-600 space-y-8">
        {/* Header */}
        <div className="sticky top-0  p-6 z-10 flex flex-wrap justify-between items-center rounded-lg border border-gray-300 dark:border-gray-600 pb-4">
          <div className="flex items-center gap-5">
            <div className="relative w-16 h-16 flex items-center justify-center rounded-lg border-[1px] border-dark  bg-light dark:bg-white  text-3xl font-semibold text-dark shadow-inner">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-1 space-y-6">
            ...
            <Section title="Personal Information" icon={<Users size={18} />}>
            ...
            <Section title="Additional Information" icon={<Info size={18} />}>
              ...
              {profile.submittedBy && (
                <div className="border-t pt-3 text-xs text-gray-500 dark:text-gray-400">
                  Submitted by: <strong>{profile.submittedBy.fullName}</strong>{" "}
